    ...
    <>
      <div className=" px-3 scroll-bar-hidden ">
        <img
          src="/image/logo.png"
          alt="logo"
          className="h-[160px] block mx-auto mt-10"
        />
        ...
        <div className="py-3 w-fit mx-auto  ">
          ...
          <motion.div
            ...
            className={
              pathname === "/search" ? "menu-active mb-3" : "menu mb-3"
            }
          ...
          <motion.div
            ...
            className={`${
              pathname === "/save-post" ? "menu-active mb-3" : "menu mb-3"
            }`}
          ...
          <motion.div
            ...
            className={
              pathname === "/profile" ? "menu-active mb-3" : "menu mb-3"
            }
